        ...
        <header className="border-b border-slate-200 bg-white">
          <div className="max-w-6xl mx-auto px-6 py-14">
            ...
            <div className="mt-6 max-w-4xl rounded-lg border border-amber-200 bg-amber-50 px-5 py-4 text-sm text-amber-900">
              ...
              content published on Thrillophilia.
            </div>
          </div>
        </header>
        ...
        <main className="max-w-6xl mx-auto px-6 py-16 space-y-20 text-slate-700 leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              <strong>Thrillophilia</strong>.
            </p>
            <p className="mt-4">
              For the purpose of this policy, “Thrillophilia”, “we”, “us”, or
              “our” refers to Thrillophilia Adventure Tours Pvt. Ltd.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">
              Ownership of Thrillophilia Content
            </h2>
            <p>
              All content displayed on Thrillophilia’s website, applications,
              and associated platforms is protected under applicable copyright
            ...
            <p className="mt-4">
              ...
              from any content without prior written consent from Thrillophilia.
            </p>
            <p className="mt-4">
          ...
          <section className="rounded-xl border border-slate-200 bg-slate-50 p-10">
            ...
            <p>
              ...
              contribute content to Thrillophilia.
            </p>
          </section>
          ...
          <section>
            ...
            <p>All content provided to Thrillophilia must be:</p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">
              License Granted to Thrillophilia
            </h2>
            <p>
              By submitting content, partners grant Thrillophilia a worldwide,
          ...
          <section>
            ...
            <p>
              Thrillophilia respects intellectual property rights and expects
              users and partners to do the same. If you believe that your
              copyrighted work has been used without authorization, please
              notify us with sufficient details to investigate the claim.
            </p>
          </section>
          ...
          <section className="border-t border-slate-200 pt-12">
            <p className="text-sm text-slate-500">
              Thrillophilia reserves the right to remove any content that
              violates copyright or intellectual property laws without prior
              notice.
            </p>
